  ...
  steps {
   ...
   stage('Check code coverage') {
      ...
      steps {
          ...
          sh 'docker build -t maheshtambelab/user-service:${VERSION} .'
          sh 'docker push maheshtambelab/user-service:${VERSION}'
      }
    } 
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: maheshtambelab\\/user-service:${VERSION}/" aws/user-manifest.yml
        '''
